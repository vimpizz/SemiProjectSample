...
public class FragmentCamera extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mImgProfile = view.findViewById(R.id.imgMemo);
        Button btnCamera = view.findViewById(R.id.btnCameraMemo);
    ...
    private void takePicture() {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
            ...
            mCaptureUri = FileProvider.getUriForFile(getContext(),
                    "com.swu.semiprojectsample", getOutPutMediaFile());
        }
    ...
    private void sendPicture() {
        ...
        //Toast.makeText(getContext(),"사진경로 : "+ mPhotoPath, Toast.LENGTH_SHORT).show();
    }
